...
function cardGen() {
  ...
  let cardValue = (cardNum === 6 || cardNum === 9) ? `<p class="align-self-center text-center text-decoration-underline" style="font-size: 15em">${cardNum}</p>` : `<p class="align-self-center text-center" style="font-size: 15em">${cardNum}</p>`
  ...
  <div id="card" class="card m-5 align-self-center" style="width: 450px">
    ...
    ${cardValue}
    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" style="transform: scaleY(-1)"
